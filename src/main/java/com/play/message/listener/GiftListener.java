...
public class GiftListener implements MessageListener {
    ...
    public void onMessage(Message message) {
        String json =  String.valueOf(message.getBody());
...
//            rongyunService.systemNoticeMessageAsync("会员中心", msgContent, userId, "会员中心-VIP升级通知");
        ...
        for(Long targetUserId : targetUserIds){
            ...
            //平台增加收益
            userAccountService.giftReceive(888888L, gift.getPrice().multiply(BigDecimal.valueOf(giftNum)).multiply(BigDecimal.valueOf(0.1)).setScale(2, BigDecimal.ROUND_HALF_UP));
            //保存账户交易记录
            ...
            platformTradeRecord.setUserId(chatroom.getOwnnerId());
            platformTradeRecord.setCreator(chatroom.getOwnnerId());
